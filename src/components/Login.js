        ...
        <div className="row w-100">
            ...
            <div className="col-md-6 col-sm-12 min-vh-100 d-flex flex-column align-center justify-content-center">
                ...
                <form className="d-flex flex-column align-items-center">
                    ...
                    <button onClick={loginButtonClick} className="btn btn-outline-success mt-4 loginbtn">Login</button>
                    <button onClick={registerClick} className="btn btn-success mt-4 loginbtn"><Link style={{textDecoration:'none',color:'white'}} to='/register'>Register</Link></button>
                </form>
            </div>
        </div>
        </>
